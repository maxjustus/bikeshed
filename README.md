For now handyman is just a collection of queries and scripts. An end goal would be to bundle these things up into a single CLI for easy installation and use.
